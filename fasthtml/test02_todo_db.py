...
"""
# script test02_todo_db.py
# a "todo" app provided by Jeremy Howard
# https://github.com/AnswerDotAI/fasthtml-example/tree/main/01_todo_app
#
# XXXXXXXXXXXX gives error on "Edit"
"""
from fasthtml.common import *
# -----------------------------------------
app,rt,todos,Todo = fast_app(   # defined in fastapp.py
    'data/todos.db',  # sqlite db 
