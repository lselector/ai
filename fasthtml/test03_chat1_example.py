...
"""
# test03_chat1_example.py
# Example of using fastapi + ollama + llama3.1
...
if __name__ == "__main__":
    uvicorn.run("test03_chat_example:app", host="localhost", port=8000, reload=True)
